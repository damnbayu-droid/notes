          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar p-8">
            <Tabs value={activeTab} className="w-full" onValueChange={setActiveTab}>
              <TabsList className="w-full bg-slate-100 dark:bg-slate-800/50 p-1.5 rounded-2xl mb-8">
                ...
                <TabsTrigger value="offline" className="flex-1 rounded-xl text-[10px] font-black uppercase tracking-widest data-[state=active]:bg-white dark:data-[state=active]:bg-slate-900 data-[state=active]:shadow-sm">
                  Offline
                </TabsTrigger>
              </TabsList>
                  ...
                  <div className="p-6 rounded-[2rem] bg-slate-50 dark:bg-slate-800/30 border border-slate-100 dark:border-white/5 space-y-6">
                     <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                           ...
                           <div>
                              <h4 className="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest italic">Neural Database Cluster</h4>
                              <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">Global Persistence Telemetry</p>
                           </div>
                        </div>
                        <div className="px-4 py-2 bg-emerald-500/10 text-emerald-500 rounded-xl text-[9px] font-black uppercase tracking-widest border border-emerald-500/20">
                           Online
                        </div>
                     </div>
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        <div className="p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-white/5">
                           <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">Total Nodes</p>
                           <p className="text-xl font-black text-slate-900 dark:text-white tracking-tighter">{diagnostics.notesCount}</p>
                        </div>
                          <div className="p-4 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-white/5">
                             <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">Project Cluster</p>
                             <p className="text-xl font-black text-slate-900 dark:text-white tracking-tighter truncate">Smart Database</p>
                          </div>
                     </div>
                     ...
                     <div className="pt-4 border-t border-slate-100 dark:border-white/5 flex flex-col gap-3">
                        <Button 
                           variant="outline" 
                           onClick={forceSync}
                           className="w-full h-12 rounded-2xl border-slate-200 dark:border-white/5 text-slate-900 dark:text-white font-black uppercase text-[9px] tracking-widest hover:bg-slate-100 dark:hover:bg-slate-800"
                        >
                           Force Neural Sync
                        </Button>
                        <Button 

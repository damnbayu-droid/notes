export interface User {
  ...
  interests?: string[]; // Neural Behavior Learning (v11.0.0)
  access_level?: 'free' | 'pro'; // Monetization Protocol
}
...
export interface Note {
  ...
  view_count?: number; // Behavioral Metrics (v12.0.0)
  click_count?: number;
  fork_count?: number;
...
export interface NoteLog {
  ...
  action: string;
  details: any;
  snapshot_content?: string; // Full HTML/Content at the time of this log (Commit snapshot)
  created_at: string;
}
